...
; (function ($) {
    $.fn.bPopup = function (options, callback) {
        ...
        id = 'bPopup' + popups,
        iframeid = (o.iframeid) ? o.iframeid : 'iframe_' + id,
        inside = isInside(),
        ...
        function close() {
            if ($.isFunction(o.onClose)) {
                //console.log($('iframe', $(o.contentContainer)).contents())
                o.onClose.call($selector, $('iframe', $(o.contentContainer)).contents());
        ...
        function createContent() {
            ...
            switch (o.content) {
                case ('iframe'):
                    $('<iframe scrolling="no" frameborder="0" allowTransparency="true"></iframe>').attr('src', o.loadUrl).attr('id', iframeid).css({ width: '660px', height: '68px' }).appendTo(o.contentContainer);
                    break;
                default:
